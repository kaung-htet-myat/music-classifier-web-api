...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'music_classifier_web_api.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'music_classifier_web_api.storage_backends.PublicMediaStorage'
else:
    STATIC_URL = '/static/'
